...
| [Target Not Found](#dfn-target-not-found) | 404 Not Found | Typically no response body. Servers SHOULD use the standard format defined in [[RFC9457]] for structured error responses when a body is returned. |
